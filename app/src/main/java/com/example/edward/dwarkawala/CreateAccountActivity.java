...
//            }
        ...
        preferences = PreferenceManager.getDefaultSharedPreferences(CreateAccountActivity.this);
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_PERMISSIONS:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    // Permission Granted
                    Snackbar.make(findViewById(android.R.id.content), "All Permissions Granted.", Snackbar.LENGTH_SHORT).show();
                } else {
                    // Permission Denied
                    Toast.makeText(CreateAccountActivity.this, "Permission Denied", Toast.LENGTH_SHORT).show();
                    finish();
                }
                break;
            default:
